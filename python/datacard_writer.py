...
class DataCardWriter:
    ...
    def preproces_data(self):
        ...
        if not self.data:
            ...
            for b in self.bgs:
                fakedata.Add(b)
            for i in range(1,fakedata.GetNbinsX()+2):
    ...
    def get_rates_str(self):
        ...
        rtn += "process                                 {}\n".format("".join(["{:<17d}".format(i) for i in range(0 - (self.nsig - 1), len(self.hists) - (self.nsig - 1))]))
        ...
        if isgmNerr:
            ...
            for proc in self.proc_names:
                if isinstance(systdict[proc], list):
                    ...
                    for i in range(1, systdict[proc].GetNbinsX()+1):
...
if __name__ == "__main__":
    ...
    systs.append( ("bkg2CRbin1", "gmN", [bkgCR2], {"signal":0, "bkg1":0, "bkg2":[ "{:.4f}".format(alpha.GetBinContent(i)) if i == 1 else "-" for i in range(1, alpha.GetNbinsX()+1) ], "bkg3":0}) )
    systs.append( ("bkg2CRbin2", "gmN", [bkgCR2], {"signal":0, "bkg1":0, "bkg2":[ "{:.4f}".format(alpha.GetBinContent(i)) if i == 2 else "-" for i in range(1, alpha.GetNbinsX()+1) ], "bkg3":0}) )
    systs.append( ("bkg2CRbin3", "gmN", [bkgCR2], {"signal":0, "bkg1":0, "bkg2":[ "{:.4f}".format(alpha.GetBinContent(i)) if i == 3 else "-" for i in range(1, alpha.GetNbinsX()+1) ], "bkg3":0}) )
    systs.append( ("bkg2CRbin4", "gmN", [bkgCR2], {"signal":0, "bkg1":0, "bkg2":[ "{:.4f}".format(alpha.GetBinContent(i)) if i == 4 else "-" for i in range(1, alpha.GetNbinsX()+1) ], "bkg3":0}) )
    systs.append( ("bkg2CRbin5", "gmN", [bkgCR2], {"signal":0, "bkg1":0, "bkg2":[ "{:.4f}".format(alpha.GetBinContent(i)) if i == 5 else "-" for i in range(1, alpha.GetNbinsX()+1) ], "bkg3":0}) )
