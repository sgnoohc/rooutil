...
//     // The first row can be list of deltaR's of first b quark from higgs to reco jets.
//     // The second row can be list of deltaR's of second b quark from higgs to reco jets.
//     // Then the output assignment[0] is the index to the reco jets best matching to the first b quark
//     // Then the output assignment[1] is the index to the reco jets best matching to the second b quark
//     //
//     //
//     vector< vector<double> > costMatrix = { { 0.16, 2.4, 2.8, 0.2, 1.5 }, 
//                                             { 0.05, 4.05, 4.8, 4.2, 4.5 } };
