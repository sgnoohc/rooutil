...
#    echo "#include \"rooutil/rooutil.h\"" >> ${MAKECLASSNAME}.h
    ...
    if [ -e process.cc ]; then
        ...
        echo "        (\"t,test\"        , \"Run test job. i.e. overrides output option to 'test.root' and 'recreate's the file.\")                                                                                                             ">>process.cc
        ...
        echo "                                                                                                                                                                                                                                  ">>process.cc
        echo "    //_______________________________________________________________________________                                                                                                                                             ">>process.cc
        echo "    // --test                                                                                                                                                                                                                     ">>process.cc
        echo "    if (result.count(\"test\"))                                                                                                                                                                                                   ">>process.cc
        echo "    {                                                                                                                                                                                                                             ">>process.cc
        echo "        ana.output_tfile = new TFile(\"test.root\", \"recreate\");                                                                                                                                                                ">>process.cc
        echo "    }                                                                                                                                                                                                                             ">>process.cc
        echo "    else                                                                                                                                                                                                                          ">>process.cc
        echo "    {                                                                                                                                                                                                                             ">>process.cc
        echo "        //_______________________________________________________________________________                                                                                                                                         ">>process.cc
        ...
        echo "    // cutflow.bookHistograms(ana.histograms); // if just want to book everywhere                                                                                                                                                 ">>process.cc
        echo "                                                                                                                                                                                                                                  ">>process.cc
